...
\NormalTok{  \}}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"Inertie précédente:"}\NormalTok{,inertie\_prec,}\StringTok{"Inertie suivante:"}\NormalTok{,inertie,}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
