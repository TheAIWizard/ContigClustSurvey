...
distance_between_groups <- function(groups,i,j,fonction_distance) {
  ...
  mean1_ponderee_hat <- sapply(data_group1[, -1], weighted.mean, w = data_group1$somme_proba_inclusion)
  mean2_ponderee_hat <- sapply(data_group2[, -1], weighted.mean, w = data_group2$somme_proba_inclusion)
