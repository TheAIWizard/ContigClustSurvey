...
```{r}
distance_Ward.D2 <- function(datagroup1,datagroup2,mean1,mean2){
...
```{r}
distance_euclidienne_ponderee <- function(datagroup1,datagroup2,mean1_ponderee1, mean1_ponderee2,w1,w2) {
  sqrt(sum(w1*w2*(mean1_ponderee - mean2_ponderee)^2)/(w1+w2))
}
```
...
```{r}
distance_Ward.D2_ponderee <- function(datagroup1,datagroup2,mean1,mean2,w1,w2){
...
distance_between_groups <- function(groups,i,j,fonction_distance,estimation_taille_commune=FALSE) {
  ...
  mean1_ponderee <- sapply(data_group1, weighted.mean, w = w1)
  mean2_ponderee <- sapply(data_group2, weighted.mean, w = w2)
  ...
  mean1_ponderee_hat <- sapply(data_group1, weighted.mean, w = w1_hat)
  mean2_ponderee_hat <- sapply(data_group2, weighted.mean, w = w2_hat)
  ...
  ifelse(estimation_taille_commune,distance<-fonction_distance(mean1_ponderee,mean2_ponderee,w1_hat,w2_hat),
         distance <- fonction_distance(mean1_ponderee,mean2_ponderee,w1,w2))
