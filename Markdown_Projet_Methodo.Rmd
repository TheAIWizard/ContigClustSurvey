...
Pour générer aléatoirement des individus dans le plan avec une forte concentration dans certaines zones, nous définissons des zones métropolitaines.
...
df <- data.frame(
  x = c(rnorm(n / 2, centers$x[1], x_max / 10), rnorm(n / 2, centers$x[2], x_max / 10)),
  y = c(rnorm(n / 2, centers$y[1], y_max / 10), rnorm(n / 2, centers$y[2], y_max / 10))
)
