...
Pour générer aléatoirement des individus dans le plan avec une forte concentration dans certaines zones, nous définissons un certain nombre de zones métropolitaines. Par défaut, nous choisissons 2 fois le nombre de carrés pour
...
df <- data.frame(x_bin = rep(1: n_squares, nb_cols_squares), 
                 y_bin = rep(n_squares:1, each = nb_cols_squares), 
                 color = color)
