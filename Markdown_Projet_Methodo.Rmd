...
Le nombre de communes pouvant s'afficher peut être nombreux nous allons donc ne faire apparaître que les agrégats comportant plus d'une commune
...
# supprimer les labels contenant NULL
labels(dend) <- lapply(labels(dend), function(x) ifelse(is.null(x), "", x))
